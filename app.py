...
api.add_resource(Users, '/users/<string:pattern>')
api.add_resource(TokenRefresh, '/token/refresh')
api.add_resource(NewProblem, '/new-problem')
...
api.add_resource(Challenges, '/challenges/<string:pattern>')
...
api.add_resource(Problems, '/problems/<int:mask>+<string:user_id>+<string:pattern>')
